...
void CFlag::Render(float minY)
{
	...
	float PosArray[] = { -radius, minY, -radius - 20.0f,  //0
						 ...
						 +radius, minY, +radius - 20.0f,  //2
						 +radius, minY, -radius - 20.0f,  //3
						 -radius, maxY, -radius - 20.0f,  //4
						 -radius, maxY, +radius - 20.0f,  //5
						 +radius, maxY, +radius - 20.0f,  //6
						 +radius, maxY, -radius - 20.0f   //7
						};
